...
public class DriveJoystick extends CommandBase {
  ...
  @Override
  public void execute() {
    drivetrain.drive(new Twist(maxVelocityInTicksper100ms * RobotContainer.drivetrainController.rightStick.getXCubedWithDeadband(0.07),
    maxVelocityInTicksper100ms * RobotContainer.drivetrainController.rightStick.getYCubedWithDeadband(0.07), 
     TURN_CONSTANT * RobotContainer.drivetrainController.leftStick.getXCubedWithDeadband(0.07)));
